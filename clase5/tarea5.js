...
document.querySelector('#calcular').onclick = function(event){
  event.preventDefault(); //evita el envio del formulario y la recarga de pagina)

  const sueldoAnual = Number(document.querySelector('#salarioAnual').value);
  let salarioMensual = sueldoAnual/mesesAño;
