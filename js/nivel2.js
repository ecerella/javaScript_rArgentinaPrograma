...
//const comidasFavoritas = ['milanesas', 'pollo', 'bondiola', 'fugazzeta'];
...
impriman los primeros 100 numeros
partida: 0/1
condicion: llegar a 100
contador: aumenta o decrementa en 1
...
//hacer una funcion que se llame calcularPromedio
...
//function parametros por default
/*
...
function verificarEdadEntrada(edad = 18){
    ...
    //el signo de pregunta reemplaza el if para evaluar y tomar en consideracion la izquierda de : por true o derecha
    // (condicion) ? izquierda : derecha;
