...
/*
    ...
    //<elemento atributos="valor" atributo2="valor"></elemento>
...
console.log(titulo.textContent); //muestra contenido de texto dentro de elemento
console.log(titulo.InnerText);  //calcula que elementos estan visibles si no estan no los muestra
console.log(titulo.innerHtml);  //string todo el HTML que hay en el elemento
...
//titulo.textContent = 'Chau' //titulo textContent "dame el valor de" pero a la izquierda de asignacion seria a titulo le asigno el string 'chau'
...
modoImagen.src = 'img/woman_bw.jpg';
document.querySelector('header').appendChild(nodoImagen);

/*
<header>
    <h1 id="titulo">Hola!</h1>
    <h2 class="importante">Escribamos un poco de codigo el dia de hoy!</h2>
