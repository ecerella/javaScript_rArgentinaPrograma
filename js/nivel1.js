...
/*
    ...
    Una variable es un lugar para guardar información. Para crear (o mejor dicho DECLARAR) una variable usamos 'let', así:
...
//let numero1 = Number(prompt('ingresa un numero')); // prompt retorna string hay que convertir a numero!
...
let anioActual = Number(prompt('Ingrese año actual'));
let anioNacimiento = Number(prompt('Ingrese año de nacimiento'));
console.log(
...
//B)
function salarioMensual(salarioAnio){
    const mesesAnio = 12
    return salarioAnio / mesesAnio; 
}
   
let salarioAnio = Number(prompt('Ingrese su salario anual'));
console.log(
    'salario mensual: ' + salarioMensual(salarioAnio)
);
...
function salarioSemanal(salarioMensual){
    const semanasMes = 4
    return salarioMensual / semanasMes;
}

function salarioDiario(salarioMensual){
    const diasMes = 24
    return salarioMensual / diasMes;
}
...
let salarioMes = Number(prompt('Ingrese su salario mensual'));

console.log(
    'salario Anual: ' + salarioAnual(salarioMes),
    'salario Semanal: ' + salarioSemanal(salarioMes),
    'salario Diario: ' + salarioDiario(salarioMes),
    'salario Hora: ' + salarioHora(salarioMes),
...
function calcularMesesVividos(anioActual, anioNacimiento, mesNacimiento){
    ...
    return (anioActual - anioNacimiento) * mesesEnUnAño + mesNacimiento;
}

let anioNacimiento = Number(prompt('En que año naciste?'));
let mesNacimiento = Number(prompt('En que mes nacise?'));

console.log(
    'Tenes ' + calcularMesesVividos(2024, anioNacimiento, mesNacimiento) + ' meses vividos'
);
*/
...
let operador = prompt('Para hacer una suma pulse(+) o una resta(-)');
...
if (operador === '+'){
    ...
    console.log(`No entiendo el operador ${operador}`) //interpolacion funciona solo con comillas invertidas
}
